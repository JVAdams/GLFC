...
_U.S. Geological Survey_ (USGS) Computer Program **GLFC** version 1.5.1.9000. 
Written by Jean V. Adams, [USGS - Great Lakes Science Center](http://www.glsc.usgs.gov/), Ann Arbor, Michigan, USA. 
Written in programming language R (R Core Team, 2019, www.R-project.org), version 3.6.2. 
